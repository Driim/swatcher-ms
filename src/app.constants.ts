...
export const FUZZY_SORT = true;
export const FUZZY_THRESHOLD = 0.4;
export const FUZZY_LOCATION = 0;
export const FUZZY_DISTANCE = 100;
export const FUZZY_PATTERN_LENGTH = 32;
export const FUZZY_MIN_MATCH = 2;
export const UI_MIN_MESSAGE = 3;

export const COMMAND_START = /\/start/i;
